...
import "./MusicListItemPublic.css";
...
const MusicListItemPublic = (props) => {
  ...
  return (
    <li className="music-item" style={{ width: width }}>
      <CollectionModal
      ...
      >
        <div className="music-item__info">
          ...
          <span className="artist">
            {music.musicArtist}-{music.musicAlbum}
          </span>
        </div>
      </Link>
      ...
      <div className="music-item__actions">
        ...
        <div className="music-item__menu-container">
          <button
            ref={triggerRef}
            className="icon-button"
