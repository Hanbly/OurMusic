...
//    private String lyricContent;
    ...
    private Instant musicTimestamp;

    public MusicDtoHistory() {
        this.musicTimestamp = Instant.now();
    }
    ...
    public Instant getMusicTimestamp() {
        return musicTimestamp;
    }

    public void setMusicTimestamp(Instant musicTimestamp) {
